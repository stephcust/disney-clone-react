...
const Header = (props) => {
    ...
    return (
        <Nav>
            ...
            {
                !userName ? (
                <Login onClick={handleAuth}>ENTRAR</Login> )
                : (
                <>
                <NavMenu>
                    <a href="/home">
                    ...
                    <a href="/home">
                        <img src="/images/originalIcon.svg" alt="ORIGINAIS"/>
                        <span>ORIGINAIS</span>
                    </a>
                    <a href="/home">
                        <img src="/images/movieIcon.svg" alt="FILMES"/>
                        <span>FILMES</span>
                    </a>
                    <a href="/home">
                        <img src="/images/seriesIcon.svg" alt="SÉRIES"/>
                        <span>SÉRIES</span>
                    </a>
                </NavMenu>
                <SignOut>
